...
module Logging =
    ...
    [<Sealed>]
    type LogMessage =
        member Category : option<string>
        member Level : LogLevel
        member Text : string

        static member Create : LogLevel * text: string -> LogMessage
        static member Create : LogLevel * category: string * text: string -> LogMessage
    ...
    type Log =
        ...
        member WithCategory : ?category: string -> Log
        member Category : option<string>
        static member Create : (LogMessage -> unit) -> Log
        static member Null : Log
