...
//module V = IntelliFactory.Build.VsixPackages
...
//    static member Create : category: seq<string> -> archive: VST.ProjectTemplate -> ProjectTemplate
//
...
//    static member ProjectTemplate : category: seq<string> -> archive: VST.ProjectTemplate -> VsixContent
//
